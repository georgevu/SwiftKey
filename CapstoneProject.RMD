...
createDataFiles <- function() {
  ...
  lines <- createSampleFile(filePath, paste0(dataDir, "sample_", blogFile), numLines)
...
predict <- function(text, numSelections) {
  ...
  return (list(selected, predictedText))
}
```
## Data Inspection
